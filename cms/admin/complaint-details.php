...
<?php $st='closed';
$query=mysqli_query($bd, "select * from tblcomplaints  where complaintNumber='".$_GET['cid']."'");
...
?>									
										<tr>
											...
											<td> <?php echo htmlentities($row['customerusername']);?></td>
											<td><b>Reg Date</b></td>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://172.22.22.2//nepalairlink/cms/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://172.22.22.2/nepalairlink/cms/admin/userprofile.php?username=<?php echo htmlentities($row['customerusername']);?>');" title="Update order">
