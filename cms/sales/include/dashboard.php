...
$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where and status is null");
...
{?>
                  ...
                  <span class="li_news"></span>
                    ...
                    $row6=mysqli_fetch_array($query22);
...
{?>
  ...
  $status="closed";                   
$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where and  status='$status'");
$num1 = mysqli_num_rows($rt);
{?>
                  <h3><?php echo htmlentities($num1);?></h3>
                        </div>
