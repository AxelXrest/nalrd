...
<body>
	<div class="container">
		...
		<div class="form-head mb20">
			<h1 class="site-logo h2 mb5 mt5 text-center text-uppercase text-bold" style="text-shadow: 2px 2px 4px #757575;">NEPAL AIRLINK CUSTOMER PORTAL</h1>
			<hr>
		</div>
		{if isset($notify)}
			<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-6" style="margin-left:24%">
				<div class="panel panel-default">
					<div class="panel-heading text-center">{$_L['Sign_In_Member']}</div>
