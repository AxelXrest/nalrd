                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<select name="user_type" id="user_type" class="form-control">
								...
								<option value="POS" {if $d['user_type'] eq 'POS'}selected="selected" {/if}>POS</option>
								<option value="Regular" {if $d['user_type'] eq 'Regular'}selected="selected" {/if}>Regular</option>
                            </select>
