	...
	<div class="col-sm-12">
		<div class="panel mb20 panel-default">
			...
			<div class="panel-body">
				...
				{* <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-3 text-right">
							<a href="{$_url}settings/dbbackup/" class="btn btn-primary btn-xs"><i
									class="fa fa-download"></i> {$_L['Download_Database_Backup']}</a>
						</div>&nbsp;
				...
				<form action="{$_url}settings/dbbackup/" method="post">
