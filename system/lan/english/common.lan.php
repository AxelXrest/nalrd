...
$_L['register_successfully'] = "Wallet Registered Successfully";



//header
$_L['user-management'] = "User Management";
...
$_L['delete_problem'] = "Cannot delete the Customers ";
$_L['Wallet'] = "Wallet";
$_L['Hotspot'] = "Hotspot";
//dashboard
$_L['total_voucher'] = "Total Voucher ";
$_L['active_voucher'] = "Active Voucher ";
$_L['used_expired_voucher'] = "Used/Expired Voucher ";
$_L['damage_returned_voucher'] = "Damaged/Returned Voucher ";
$_L['total_user'] = "Total User ";
$_L['active_user'] = "Active User ";
$_L['expired_user'] = "Expired User ";
$_L['disabled_user'] = "Disabled User ";

//user-management

$_L['Add_Contacts'] = "Add New";
$_L['Edit_Contacts'] = "Edit";
$_L['Disable_Contact'] = "Disable";
$_L['Activate_Contacts'] = "Activate";
$_L['Deactivate_Contacts'] = "Deactivate";
$_L['Recharge_Contacts'] = "Recharge";
$_L['SN'] = "S.N.";
$_L['Customer'] = "Customer";
$_L['Profile'] = "Profile";
$_L['Created_date'] = "Created_date";
$_L['Login_date'] = "Login Date";
$_L['Expire_date'] = "Expire Date";
$_L['Uses'] = "Uses";
$_L['POS_owner'] = "POS Owner";
$_L['Status'] = "Status";


//bandwidth-add
$_L['bw_Cancel']="Cancel";
$_L['bw_add']="Add New Bandwidth";

//hotspot-management
$_L['add_hotspot'] = "Add Hotspot Plan";
$_L['delete_hotspot'] = "Delete";

$_L['api_nas'] = "API NAS";


//hotspot add
$_L['nas_type'] = "Specific API NAS";


$_L['plan_packages'] = "Create Plan ";
$_L['batch_user_generate'] = "Batch User Generate";
$_L['Hour'] = "Hours";
$_L['batch_recharge'] = "Batch Recharge";
$_L['Batch'] ="Batch";
$_L['packages']="Packages";
$_L['hotspot']="HOTSPOT";
$_L['error_recharge'] = "There Is No Sufficient Available Balance In Your Account";
$_L['Recharged_Successfully'] = "Recharged Successfully";
$_L['loaded_successfully']="Loaded Successfully";
$_L['wallet_available'] = "Available Balance";
$_L['wallet_credit'] = "Credit Balance";
$_L['wallet_limit'] = "Credit Limit";
$_L['wallet'] = "Wallet";
$_L['Latest_Expired_Account'] = "Latest Expired Account";
$_L['latest_expired_report'] = "Latest Expired";
$_L['Regular'] = 'Regular';
$_L['monitor_nas'] = 'Monitor NAS';
$_L['Login'] = 'Log-in';
...
$_L['Bandwidth_Plans'] = 'Bandwidth Plan';
