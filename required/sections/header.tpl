			...
			{if $_admin['user_type'] eq 'Admin' || $_admin['user_type'] eq 'Sales' || $_admin['user_type'] eq 'Regular'}
				<div class="profile clearfix mb15">
					...
					<div class="group">
						...
						<small class="desig">{if $_admin['user_type'] eq 'Admin'} {$_L['Administrator']} {elseif $_admin['user_type'] eq 'Sales'} {$_L['Sales']} {else}{$_L['Regular']} {/if}</small>
					</div>
				</div>
			{else}
				<div class="profile clearfix mb15">
			...
			{/if}
				...
				{if $_admin['user_type'] eq 'Admin' || $_admin['user_type'] eq 'Sales'}
					...
					<li {if $_system_menu eq 'hotspot'}class="open"{/if}>
						...
						<ul class="inner-drop list-unstyled">
							<li {if $_system_menu eq 'services'}class="active"{/if}><a href="{$_url}hotspot/packages">{$_L['packages']}</a></li>
						</ul>
					</li>
					...
					<li {if $_system_menu eq 'reports'}class="open"{/if}>
						...
						<ul class="inner-drop list-unstyled">
							...
							<li {if $_system_menu eq 'reports'}class="active"{/if}><a href="{$_url}latestExpire/latest_expired">{$_L['latest_expired_report']}</a></li>
						</ul>
					</li>


						<li {if $_system_menu eq 'monitor_nas'}class="open"{/if}>
						<a href="{$_url}monitornas/logs" >
							<i class="ion ion-clipboard"></i>
				...
				{/if}
				{if $_admin['user_type'] eq 'Sales' || $_admin['user_type'] eq 'Regular'}
				<li {if $_system_menu eq 'CMS'}class="active"{/if}>
